import { StyleSheet, Text, View, Image, Pressable, ScrollView, KeyboardAvoidingView, Platform, StatusBar } from 'react-native';
        ...
        >
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                ...
                <View style={[styles.input_container, { backgroundColor: theme.background2 }]}>
                    <Text style={[styles.heading, { color: theme.heading }]}>Pickup Address</Text>
                    <Input Icon={Pick} placeholder="No 2, Balonny Close, Allen Avenue" />
                    <Button buttonText="Package Picked up" onPress={() => { router.push('(screens)/placeOrder') }} />
                </View>
                </View>
            </ScrollView>
        </KeyboardAvoidingView>
